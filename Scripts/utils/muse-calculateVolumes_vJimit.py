...
def usage():
  ...
  Derived:
    ...
    [-m --map	    ]	< file  >	Mapping for all derived ROIs (optional, valid only if calculating derived volumes)
    					default: '/cbica/software/lab/MUSE/centos7/3.0.5/data/List/MUSE_DerivedROIs_Mappings.csv'
...
ROIlist 	= []
Vollist 	= []
mapcsv 		= '/cbica/software/lab/MUSE/centos7/3.0.5/data/List/MUSE_DerivedROIs_Mappings.csv'
